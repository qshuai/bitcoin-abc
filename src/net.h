...
struct CNodeSignals {
    boost::signals2::signal<bool(const Config &, CNode *, CConnman &, std::atomic<bool> &), CombinerAll> ProcessMessages;
    boost::signals2::signal<bool(const Config &, CNode *, CConnman &, std::atomic<bool> &), CombinerAll> SendMessages;
    boost::signals2::signal<void(const Config &, CNode *, CConnman &)> InitializeNode;
