 ...
 */
    struct BIP9Deployment {
        ...
        // The bit determines which bit in the nVersion field of the block is to be
        // used to signal the soft fork lock-in and activation. It is chosen from the set
        // {0,1,2,...,28}.
        // bit表示软分叉升级需要设置的位，从{0,1,2,...,28}中选择一个
        int bit;
 ...
 */
    struct Params {
         ...
         */
        uint32_t nRuleChangeActivationThreshold;        // startTime之后必须在这个期限内更新所需要设置的位
